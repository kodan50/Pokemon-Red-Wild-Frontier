...
CinnabarIsland_Object:
	...
	warp_event 9, 11, CINNABAR_POKECENTER, 1
	warp_event 13, 11, CINNABAR_MART, 1

	def_bg_events
	bg_event  9,  5, TEXT_CINNABARISLAND_SIGN
	bg_event 14, 11, TEXT_CINNABARISLAND_MART_SIGN
	bg_event 10, 11, TEXT_CINNABARISLAND_POKECENTER_SIGN
	bg_event  7, 11, TEXT_CINNABARISLAND_POKEMONLAB_SIGN
	bg_event 17,  5, TEXT_CINNABARISLAND_GYM_SIGN
